...
def build_metadata_header(samples: list[Sample] | None = None) -> str:
    ...
    w("#ifndef MARVIN_GAMEPLAY_METADATA_H")
    w("#define MARVIN_GAMEPLAY_METADATA_H")
    w("#include <stdint.h>")
    w("")
    ...
    w("#define GP_SCORE_INK_NUM %d          /* ink threshold = NUM/DEN of the band luma range */" % scfg.ink_num)
    w("#define GP_SCORE_INK_DEN %d" % scfg.ink_den)
    ...
    w("#define GP_STREAK_INK_NUM %d        /* ink threshold = NUM/DEN of the cell luma range */" % tcfg.ink_num)
    w("#define GP_STREAK_INK_DEN %d" % tcfg.ink_den)
