...
SONGS = [
    ...
    ("main", 5,  "sabotage",                  "Sabotage",                  "Beastie Boys",            "Ill Communication"),
    ("main", 6,  "mississippi_queen",         "Mississippi Queen",         "Mountain",                "Climbing!"),
    ("main", 7,  "school_s_out",              "School's Out",              "Alice Cooper",            "School's Out"),
    ("main", 8,  "sunshine_of_your_love",     "Sunshine of Your Love",     "Cream",                   "Disraeli Gears"),
    ("main", 9,  "barracuda",                 "Barracuda",                 "Heart",                   "Little Queen"),
    ("main", 10, "bulls_on_parade",           "Bulls on Parade",           "Rage Against the Machine","Evil Empire"),
    ("main", 11, "reptilia",                  "Reptilia",                  "The Strokes",             "Room on Fire"),
    ("main", 12, "when_you_were_young",       "When You Were Young",       "The Killers",             "Sam's Town"),
    ("main", 13, "miss_murder",               "Miss Murder",               "AFI",                     "Decemberunderground"),
    ("main", 14, "the_seeker",                "The Seeker",                "The Who",                 "Meaty Beaty Big and Bouncy"),
    ("main", 15, "lay_down",                  "Lay Down",                  "Priestess",               "Hello Master"),
    ("main", 16, "paint_it_black",            "Paint It Black",            "The Rolling Stones",      "Aftermath"),
    ("main", 17, "suck_my_kiss",              "Suck My Kiss",              "Red Hot Chili Peppers",   "Blood Sugar Sex Magik"),
    ("main", 18, "paranoid",                  "Paranoid",                  "Black Sabbath",           "Paranoid"),
    ("main", 19, "anarchy_in_the_u_k",        "Anarchy in the U.K.",       "Sex Pistols",             "Never Mind the Bollocks, Here's the Sex Pistols"),
    ...
    ("main", 27, "la_grange",                 "La Grange",                 "ZZ Top",                  "Tres Hombres"),
    ("main", 28, "welcome_to_the_jungle",     "Welcome to the Jungle",     "Guns N' Roses",           "Appetite for Destruction"),
    ("main", 29, "helicopter",                "Helicopter",                "Bloc Party",              "Silent Alarm"),
    ("main", 30, "black_magic_woman",         "Black Magic Woman",         "Santana",                 "Abraxas"),
    ("main", 31, "cherub_rock",               "Cherub Rock",               "The Smashing Pumpkins",   "Siamese Dream"),
    ("main", 32, "black_sunshine",            "Black Sunshine",            "White Zombie",            "La Sexorcisto: Devil Music Volume One"),
    ("main", 33, "the_metal",                 "The Metal",                 "Tenacious D",             "The Pick of Destiny"),
    ("main", 34, "pride_and_joy",             "Pride and Joy",             "Stevie Ray Vaughan",      "Texas Flood"),
    ("main", 35, "monsters",                  "Monsters",                  "Matchbook Romance",       "West for Wishing"),
    ("main", 36, "before_i_forget",           "Before I Forget",           "Slipknot",                "Vol. 3: (The Subliminal Verses)"),
    ("main", 37, "stricken",                  "Stricken",                  "Disturbed",               "Ten Thousand Fists"),
    ("main", 38, "3_s_7_s",                   "3's & 7's",                 "Queens of the Stone Age", "Era Vulgaris"),
    ("main", 39, "knights_of_cydonia",        "Knights of Cydonia",        "Muse",                    "Black Holes and Revelations"),
    ("main", 40, "cult_of_personality",       "Cult of Personality",       "Living Colour",           "Vivid"),
    ("main", 41, "raining_blood",             "Raining Blood",             "Slayer",                  "Reign in Blood"),
    ("main", 42, "cliffs_of_dover",           "Cliffs of Dover",           "Eric Johnson",            "Ah Via Musicom"),
    ("main", 43, "the_number_of_the_beast",   "The Number of the Beast",   "Iron Maiden",             "The Number of the Beast"),
    ("main", 44, "one",                       "One",                       "Metallica",               "...And Justice for All"),
...
def main():
    ...
    nod_trims = read_nod_trims(args.catalog) if args.catalog else {}
