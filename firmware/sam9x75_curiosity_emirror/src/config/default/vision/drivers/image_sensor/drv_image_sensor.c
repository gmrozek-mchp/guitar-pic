...
uint32_t DRV_ImageSensor_Flip(DRV_IMAGE_SENSOR_OBJ* isensor, uint32_t Flip) {
    bool status;
    ...
    static const DRV_IMAGE_SENSOR_REG flist[] ={
    {0x0100, 0x00},
    {0x0172, 0x03},
    {0x0100, 0x01}
    };

    const DRV_IMAGE_SENSOR_REG* next = flist;
