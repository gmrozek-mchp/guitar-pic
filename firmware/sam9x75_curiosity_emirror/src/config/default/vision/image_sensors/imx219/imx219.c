...
static const DRV_IMAGE_SENSOR_REG imx219_raw_wvga[] ={
    {0x0100, 0x00},
    //Begin - Acces command sequence to access in this address area "0x3000-0x5FFF"
    {0x30EB, 0x05},
    {0x30EB, 0x0C},
    ...
    {0x0160, 0x01}, //FRAME_LENGHT_A[15:8]
    ...
    {0x0176, 0x01}, //BINNING_MODE_H_A 0: average, 1: sum
    {0x0177, 0x01}, //BINNING_MODE_V_A 0: average, 1: sum

    {0x0189, 0x7F}, //Analog gain (short exposure
    
    {0x018A, 0x0F}, //Coarse integ time (short exposure)
    {0x018b, 0xF4}, //Coarse integ time (short exposure)
...
//    {0x0177, 0x01}, //BINNING_MODE_V_A 0: average, 1: sum
//
//    {0x0189, 0xE6}, //Analog gain (short exposure
    
//    {0x018A, 0x01}, //Coarse integ time (short exposure)
//    {0x018b, 0xF4}, //Coarse integ time (short exposure)
...
static const DRV_IMAGE_SENSOR_REG imx219_raw_1080p[] ={
    ...
    {0x0176, 0x00}, //BINNING_MODE_H_A 0: average, 1: sum
    {0x0177, 0x00}, //BINNING_MODE_V_A 0: average, 1: sum

    {0x0189, 0xE8}, //Analog gain (short exposure
...
static const DRV_IMAGE_SENSOR_CONFIGS imx219_raw_wvga_config ={
    0,
