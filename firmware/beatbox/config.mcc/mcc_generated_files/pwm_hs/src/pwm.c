...
void PWM_Initialize (void)
{
    ...
    // PSS 0x0; 
    PG1CLPCI2 = 0x0UL;
    // MODSEL Independent Edge; CLKSEL Master clock; HREN enabled; TRGCNT 1; ON disabled; SOCS Self-trigger; TRGMOD PWM Generator operates in Single Trigger mode; UPDMOD SOC; MSTEN disabled; MPHSEL disabled; MPERSEL enabled; MDCSEL disabled; 
    PG1CON = 0x40000088UL;
    // DC 0; 
    PG1DC = 0x0UL;
    // DCA 0x0; 
    ...
    // DTL 0; DTH 0; 
    PG1DT = 0x0UL;
    // ADTR1EN1 enabled; ADTR1EN2 disabled; ADTR1EN3 disabled; ADTR1PS 1:4; ADTR1OFS None; DACTREN1 disabled; DACTREN2 disabled; PGTRGSEL Trigger A compare event; UPDTRG Manual; PWMPCI PWM1; IEVTSEL EOC; SIEN disabled; FFIEN disabled; CLIEN disabled; FLT1IEN disabled; FLT2IEN disabled; 
    PG1EVT1 = 0x10019UL;
    ...
    // PSS 0x0; 
    PG1FFPCI2 = 0x0UL;
    // POLL Active-high; POLH Active-high; PENL disabled; PENH enabled; PMOD Independent; DTCMPSEL PCI Sync Logic; PPSEN enabled; FORCEON disabled; SWAP disabled; CAPTRSEL disabled; CAPTREN disabled; CAPSRC Software; CAPEN disabled; 
    PG1IOCON1 = 0x218UL;
    ...
    // PSS 0x0; 
    PG2CLPCI2 = 0x0UL;
    // MODSEL Independent Edge; CLKSEL Master clock; HREN enabled; TRGCNT 1; ON disabled; SOCS Trigger output selected by PG1; TRGMOD PWM Generator operates in Single Trigger mode; UPDMOD SOC; MSTEN disabled; MPHSEL disabled; MPERSEL enabled; MDCSEL disabled; 
    PG2CON = 0x40010088UL;
    // DC 0; 
    PG2DC = 0x0UL;
    // DCA 0x0; 
    ...
    // DTL 0; DTH 0; 
    PG2DT = 0x0UL;
    // ADTR1EN1 disabled; ADTR1EN2 disabled; ADTR1EN3 disabled; ADTR1PS 1:1; ADTR1OFS None; DACTREN1 disabled; DACTREN2 disabled; PGTRGSEL EOC event; UPDTRG Manual; PWMPCI PWM1; IEVTSEL EOC; SIEN disabled; FFIEN disabled; CLIEN disabled; FLT1IEN disabled; FLT2IEN disabled; 
    PG2EVT1 = 0x0UL;
    // ADTR2EN1 disabled; ADTR2EN2 disabled; ADTR2EN3 disabled; ADTR2PS 1:1; ADTR2OFS None; CAPTRPS 1:1; CAPTROFS None; 
    PG2EVT2 = 0x0UL;
    // BPSEL PWM Generator 1; AQSS None; AQPS Not inverted; TERM Manual Terminate; TSYNCDIS PWM EOC; TQSS None; TQPS Not inverted; LATMOD disabled; SWPCIM PCI acceptance logic; SWPCI Drives '0'; ACP Level-sensitive; TERMPS disabled; PPS Not inverted; PSYNC disabled; SWTERM disabled; BPEN disabled; 
