...
/** 
  ...
  @brief    This macro is used to read the input clock frequency (in Hz) for 
            Master settings.
*/
#define PWM_MASTER_CLOCK_FREQUENCY_IN_HZ        800000000UL
...
/** 
  ...
  @brief    This macro is used to read the input clock frequency (in Hz) for 
            PWM Generator 1.
*/
#define PWM_GENERATOR_1_CLOCK_FREQUENCY_IN_HZ        800000000UL
/** 
  @ingroup  pwmdriver
  @brief    This macro is used to read the input clock frequency (in Hz) for 
            PWM Generator 2.
*/
#define PWM_GENERATOR_2_CLOCK_FREQUENCY_IN_HZ        800000000UL
 ...
 */
#define PWM_HS_CommonEventCallbackRegister PWM_CommonEventCallbackRegister
/**
 * @ingroup  pwmdriver
...
inline static void PWM_PeriodSet(enum PWM_GENERATOR genNum,uint32_t period)
{
    switch(genNum) { 
        case PWM_GENERATOR_1:
                PG1PER = period & 0x000FFFFFUL;;
                break;       
        case PWM_GENERATOR_2:
                PG2PER = period & 0x000FFFFFUL;;
                break;       
        default:break;    
    }   
}
...
inline static void PWM_DutyCycleSet(enum PWM_GENERATOR genNum,uint32_t dutyCycle)
{
    switch(genNum) { 
        case PWM_GENERATOR_1:
                PG1DC = dutyCycle & 0x000FFFFFUL;
                break;       
        case PWM_GENERATOR_2:
                PG2DC = dutyCycle & 0x000FFFFFUL;
                break;       
        default:break;    
    }  
}
...
inline static void PWM_PhaseSet(enum PWM_GENERATOR genNum,uint32_t phase)
{
    switch(genNum) { 
        case PWM_GENERATOR_1:
                PG1PHASE = phase & 0x000FFFFFUL; 
                break;       
        case PWM_GENERATOR_2:
                PG2PHASE = phase & 0x000FFFFFUL; 
                break;       
        default:break;    
    } 
}
...
inline static void PWM_TriggerCompareValueSet(enum PWM_GENERATOR genNum,uint32_t trigCompValue)
{
    switch(genNum) { 
        case PWM_GENERATOR_1:
                PG1TRIGA = trigCompValue & 0x000FFFFFUL;
                break;      
        case PWM_GENERATOR_2:
                PG2TRIGA = trigCompValue & 0x000FFFFFUL;
                break;      
        default:break;    
    }
}
...
{ 
    switch(genNum) { 
        case PWM_GENERATOR_1:
                PG1TRIGA = trigA & 0x800FFFFFUL;
                break;       
        case PWM_GENERATOR_2:
                PG2TRIGA = trigA & 0x800FFFFFUL;
                break;       
        default:break;    
    }
}
...
inline static void PWM_TriggerBCompareValueSet(enum PWM_GENERATOR genNum,uint32_t trigB)
{
    switch(genNum) { 
        case PWM_GENERATOR_1:
                PG1TRIGB = trigB & 0x800FFFFFUL;
                break;       
        case PWM_GENERATOR_2:
                PG2TRIGB = trigB & 0x800FFFFFUL;
                break;       
        default:break;    
    }
}
...
inline static void PWM_TriggerCCompareValueSet(enum PWM_GENERATOR genNum,uint32_t trigC)
{
    switch(genNum) { 
        case PWM_GENERATOR_1:
                PG1TRIGC = trigC & 0x800FFFFFUL;
                break;
        case PWM_GENERATOR_2:
                PG2TRIGC = trigC & 0x800FFFFFUL;
                break;
        default:break;    
    }
}
...
inline static void PWM_TriggerDCompareValueSet(enum PWM_GENERATOR genNum,uint32_t trigD)
{
    switch(genNum) { 
        case PWM_GENERATOR_1:
                PG1TRIGD = trigD & 0x800FFFFFUL;
                break;
        case PWM_GENERATOR_2:
                PG2TRIGD = trigD & 0x800FFFFFUL;
                break;
        default:break;    
    }
}
...
inline static void PWM_TriggerECompareValueSet(enum PWM_GENERATOR genNum,uint32_t trigE)
{
    switch(genNum) { 
        case PWM_GENERATOR_1:
                PG1TRIGE = trigE & 0x800FFFFFUL;
                break;
        case PWM_GENERATOR_2:
                PG2TRIGE = trigE & 0x800FFFFFUL;
                break;
        default:break;    
    }
}
...
inline static void PWM_TriggerFCompareValueSet(enum PWM_GENERATOR genNum,uint32_t trigF)
{
    switch(genNum) { 
        case PWM_GENERATOR_1:
                PG1TRIGF = trigF & 0x800FFFFFUL;
                break;
        case PWM_GENERATOR_2:
                PG2TRIGF = trigF & 0x800FFFFFUL;
                break;
        default:break;    
    }
}
