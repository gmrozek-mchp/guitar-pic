...
static const node_info_t NODE[NODE_N] = {
    ...
    },
    {
        ...
        .prose = {
            "guitar is the hands. One byte arrives over the bus -",
            "which frets are held, and whether to strum - and a lamp",
            "lights at every button that byte calls for. The same",
            "mapping drives a real controller's switches, unchanged.",
            "",
    ...
    },
    {
        ...
        .prose = {
            ...
            "microsecond per bit. MVIO - Multi-Voltage I/O - lets",
            "this part power a bank of its pins from a second rail,",
            "at 5 V, so it drives the strips with no level shifter.",
        },
        .built = {
            "PIC32CM6408PL10048 - 5 V Cortex-M0+ MCU, 64 KB, 24 MHz",
            "PIC32CM PL10 Curiosity Nano (EV10P22A)",
            "MVIO - Multi-Voltage I/O: a second supply rail, VDDIO2,",
            "powers a bank of pins at its own voltage - here 5 V",
     ...
     * thing got written, which is the part visitors ask about. */
    {
        ...
        .tag = { "The band - plays Guitar", "Hero all by itself" },
        .tagline = "The band - all seven boards, playing Guitar Hero by itself",
