...
/* No-op while the STREAK block is hidden on both player cards (STREAK_SHOWN in
 * screen_dashboard.c): no streak reader is trusted enough to put a number on screen. */
