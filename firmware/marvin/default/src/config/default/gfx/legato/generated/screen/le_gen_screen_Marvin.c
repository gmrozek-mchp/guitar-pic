...
leResult screenShow_Marvin(void)
{
    ...
    Marvin_LABEL_DASHBOARD_ROBOT_SCORE->fn->setSize(Marvin_LABEL_DASHBOARD_ROBOT_SCORE, 37, 16);
    Marvin_LABEL_DASHBOARD_ROBOT_SCORE->fn->setScheme(Marvin_LABEL_DASHBOARD_ROBOT_SCORE, &text_dimgray);
    ...
    Marvin_LABEL_SETLIST->fn->setScheme(Marvin_LABEL_SETLIST, &SCHEME_TEXT_GRAY_71717B);
    ...
    Marvin_LABEL_SONG_SELECT_DIFFICULTY->fn->setScheme(Marvin_LABEL_SONG_SELECT_DIFFICULTY, &SCHEME_TEXT_GRAY_71717B);
    ...
    Marvin_LABEL_SONG_SELECT_MODE->fn->setScheme(Marvin_LABEL_SONG_SELECT_MODE, &SCHEME_TEXT_GRAY_71717B);
