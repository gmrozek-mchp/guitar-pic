...
leResult screenShow_Marvin(void)
{
    ...
    Marvin_IMAGE_DASHBOARD_ROBOT_PLAYER->fn->setImage(Marvin_IMAGE_DASHBOARD_ROBOT_PLAYER, (leImage*)&PLAYER_ROBOT_ART);
    ...
    Marvin_IMAGE_DASHBOARD_HUMAN_PLAYER->fn->setImage(Marvin_IMAGE_DASHBOARD_HUMAN_PLAYER, (leImage*)&PLAYER_HUMAN_ART);
