...
(`screen /dev/cu.usbserial-...2 115200`) and run (all numbers **hex**, erase length
64 KiB-aligned) `sf probe 0`, `sf erase 0x0 0x3f0000`, `sf write 0x21100000 0x0
0x3e8000`, then `sf read 0x21600000 0x0 0x3e8000` + `cmp.b 0x21100000 0x21600000
0x3e8000` (expect `Total of ... were the same`, no `!=` line). `0x3e8000` =
4,096,000 = the splash size; `0x3f0000` is that rounded up to 64 KiB.
